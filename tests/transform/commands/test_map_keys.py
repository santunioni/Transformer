    ...
    def setUp(self) -> None:
        ...
        self.data = {"id": 1645687,
                     "cliente": {"nome": "Marli Aparecida Ana das Neves",
                                 ...
                                 "valor_parcela": 100,
                                 "prazo": 84,
                                 "dados_bancarios": [{"tipo_conta": "CONTA_CORRENTE_INDIVIDUAL",
                                                      "numero_banco": "001",
                                                      "numero_agencia": "265",
                                                      "digito_agencia": "4",
                                                      "numero_conta": "71444",
                     ...
                     "codigo_orgao": "000501",
                     "operacoes_credito": [{"condicao_credito": {"sucesso": True,
                                                                 "mensagem_erro": "",
                                                                 "prazo": 84,
